<?php
	...
	$advance_automobile_sticky_header_padding_settings = get_theme_mod('advance_automobile_sticky_header_padding_settings', 0);
	$advance_automobile_custom_css .='.fixed-header{';
		$advance_automobile_custom_css .='padding: '.esc_attr($advance_automobile_sticky_header_padding_settings).'px;';
	$advance_automobile_custom_css .='}';

	// woocommerce Product Navigation
	$advance_automobile_products_navigation = get_theme_mod('advance_automobile_products_navigation', 'Yes');
	if($advance_automobile_products_navigation == 'No'){
		$advance_automobile_custom_css .='.woocommerce nav.woocommerce-pagination{';
			$advance_automobile_custom_css .='display: none;';
		$advance_automobile_custom_css .='}';
	}

	// featured image setting
	$advance_automobile_featured_img_border_radius = get_theme_mod('advance_automobile_featured_img_border_radius', 0);
	$advance_automobile_custom_css .='.our-services img, .box-img img{';
		$advance_automobile_custom_css .='border-radius: '.esc_attr($advance_automobile_featured_img_border_radius).'px;';
	$advance_automobile_custom_css .='}';

	$advance_automobile_featured_img_shadow = get_theme_mod('advance_automobile_featured_img_shadow',0);
	$advance_automobile_custom_css .='.our-services img, .page-box-single img, .middle-align img{';
		$advance_automobile_custom_css .='box-shadow: '.esc_attr($advance_automobile_featured_img_shadow).'px '.esc_attr($advance_automobile_featured_img_shadow).'px '.esc_attr($advance_automobile_featured_img_shadow).'px #ccc;';
	$advance_automobile_custom_css .='}';

	// slider top and bottom padding
	$advance_automobile_top_bottom_slider_content_space = get_theme_mod('advance_automobile_top_bottom_slider_content_space');
	$advance_automobile_left_right_slider_content_space = get_theme_mod('advance_automobile_left_right_slider_content_space');
	$advance_automobile_custom_css .='#slider .carousel-caption, #slider .inner_carousel, #slider .inner_carousel h1, #slider .inner_carousel p, #slider .readbutton{';
		$advance_automobile_custom_css .='top: '.esc_attr($advance_automobile_top_bottom_slider_content_space).'%; bottom: '.esc_attr($advance_automobile_top_bottom_slider_content_space).'%;left: '.esc_attr($advance_automobile_left_right_slider_content_space).'%;right: '.esc_attr($advance_automobile_left_right_slider_content_space).'%;';
	$advance_automobile_custom_css .='}';

	/*------------- Navigation Menu Font Size ------------------*/
	$advance_automobile_menu_font_size = get_theme_mod('advance_automobile_menu_font_size');{
		$advance_automobile_custom_css .='.primary-navigation a, .primary-navigation ul ul a, .sf-arrows .sf-with-ul:after, #menu-sidebar .primary-navigation a{';
			$advance_automobile_custom_css .='font-size: '.esc_attr($advance_automobile_menu_font_size).'px;';
		$advance_automobile_custom_css .='}';
	}

	// menu text-transform
	$advance_automobile_theme_lay = get_theme_mod( 'advance_automobile_menu_text_tranform_option','Uppercase');
	if($advance_automobile_theme_lay == 'Capitalize'){
		$advance_automobile_custom_css .='.primary-navigation a{';
			$advance_automobile_custom_css .='text-transform:Capitalize;';
		$advance_automobile_custom_css .='}';
	}
	if($advance_automobile_theme_lay == 'Lowercase'){
		$advance_automobile_custom_css .='.primary-navigation a{';
			$advance_automobile_custom_css .='text-transform:Lowercase;';
		$advance_automobile_custom_css .='}';
	}
