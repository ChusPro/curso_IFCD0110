...
= 0.7.3 =
* Added hover effect for date and author in blog page.
...
= 0.8 =
* Added show/hide search option for desktop media.
* Updated POT file.
...
* Added target='_blank' in anchor tags.
* Updated POT file.

= 0.8.3 =
* Added menu text-transform option.
* Updated POT file.
