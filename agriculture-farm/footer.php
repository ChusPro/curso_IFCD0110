...
<?php if( get_theme_mod( 'agriculture_farm_enable_disable_scroll',true) != '' || get_theme_mod( 'agriculture_farm_responsive_scroll',true) != '') { ?>
  <?php $agriculture_farm_theme_lay = get_theme_mod( 'agriculture_farm_scroll_setting','Right');
    if($agriculture_farm_theme_lay == 'Left'){ ?>
      <button id="scroll-top" class="left-align" title="<?php esc_attr_e('Scroll to Top','agriculture-farm'); ?>"><span class="fas fa-chevron-up" aria-hidden="true"></span><span class="screen-reader-text"><?php esc_html_e('Scroll to Top', 'agriculture-farm'); ?></span></button>
    <?php }else if($agriculture_farm_theme_lay == 'Center'){ ?>
      <button id="scroll-top" class="center-align" title="<?php esc_attr_e('Scroll to Top','agriculture-farm'); ?>"><span class="fas fa-chevron-up" aria-hidden="true"></span><span class="screen-reader-text"><?php esc_html_e('Scroll to Top', 'agriculture-farm'); ?></span></button>
    <?php }else{ ?>
      <button id="scroll-top" title="<?php esc_attr_e('Scroll to Top','agriculture-farm'); ?>"><span class="fas fa-chevron-up" aria-hidden="true"></span><span class="screen-reader-text"><?php esc_html_e('Scroll to Top', 'agriculture-farm'); ?></span></button>
  <?php }?>
<?php }?>
