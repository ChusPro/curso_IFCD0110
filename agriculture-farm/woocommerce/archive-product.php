...
<?php
 $agriculture_farm_shop_page_sidebar = get_theme_mod( 'agriculture_farm_shop_page_sidebar',true );
 if ( false == $agriculture_farm_shop_page_sidebar ) {
...
<div class="container">
	<main role="main" id="maincontent">
		<div class="row m-0">
			...
			<?php if ( false != $agriculture_farm_shop_page_sidebar ) {?>
