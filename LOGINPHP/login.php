<?php
 /*  ini_set('display_errors', '1');
     ...
     //estos headers son una plantilla para poder conectarnos a la BD
    ...
    if (!isset($data['user']) || !isset($data['password'])){
     ...
     //Extraemos de los datos el dato de nombre de usuario enviado por el client
     $user = $data["user"];
 ...
 exit;  //el exit es necesario para salir de cualquier consulta
